            ...
            <div class="col-lg-9 mt-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Registrarse</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Verificar</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row mb-3">
                            <label class=" col-sm-2 col-form-label">Precio de la habitación</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Conteo de días</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Insuficiente</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="POST"
                                    ...
                                    @enderror
                                    <button class="btn btn-success float-end">Pagar</button>
                                </form>
                            </div>
                        </div>
                    </div>
